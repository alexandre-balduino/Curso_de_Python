...
​
- **Função Personalizada** (O seu "Mundo 4"): Crie uma função normal em Python chamada classificar_duracao(minutos). Se a visita durou até 30 minutos, retorne 'Rápida'. Se durou entre 31 e 60 minutos, retorne 'Padrão'. Se durou mais de 60 minutos, retorne 'Longa'.
